...
import { LearnCard, Screen, Text, CircularProgress } from '@/component';
    ...
    (item: LearnFilter) => {
      ...
      return (
        <Pressable
          ...
          <Text text={item.label} style={[styles.chipLabel, active && styles.chipLabelActive]} />
  ...
  return (
    <Screen scroll contentContainerStyle={styles.screenContent}>
        ...
        <View style={styles.headerRight}>
          <DropdownMenu.Root>
            ...
            <DropdownMenu.Content>
              {languages.map(l => (
                <DropdownMenu.Item key={l.code} onSelect={() => switchLang(l.code)}>
      ...
      <View style={styles.card}>
        ...
        <Icon name="bulb" size={24} color={colors.amber} style={styles.bulb} />
